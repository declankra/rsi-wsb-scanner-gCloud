...
from rsiFilterConcurrent4o import filter_stocks_by_rsi # Import the function
import json
import requests
...
def main_process(user_variables,result_headers,history_headers):
    ...
    rsi_filtered_stocks = filter_stocks_by_rsi(symbols, rsiPeriod, rsiThreshold) ####!!!!!! add 14, 90 if testing locally
